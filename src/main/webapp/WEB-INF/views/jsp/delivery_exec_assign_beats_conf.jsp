		...
		<div class="row top-height">
			<div class="col-md-8 ">
					...
					<div class="form_submit">
						<a href="<%=request.getContextPath()%>/web/deliveryWeb/beatlist" class="btn btn-primary">View Delivery Executive to Beats Mapping</a>
						<a href="<%=request.getContextPath()%>/web/deliveryWeb/assignBeatForm" class="btn btn-primary">New Beat Assignment</a>
					</div>
			</div>
		</div>
	</div>
