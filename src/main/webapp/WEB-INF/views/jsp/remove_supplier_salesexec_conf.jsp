...
<head>
<title>Removed Supplier Sales Executive Mapping</title>
<meta charset="UTF-8">
		...
		<div class="row top-height">
			<div class="col-md-8 ">
					...
					<c:choose>
    					...
    					<c:otherwise>
        					<div class="alert alert-success">
	 						 <strong>Success!</strong><br> Supplier and Sales Executives association has been successfully removed.
						</div>
    					</c:otherwise>
					</c:choose>
					<div class="form_submit">
						...
						<a href="<%=request.getContextPath()%>/web/supplierWeb/assignSalesExecutive" class="btn btn-primary">New Supplier to Sales Executive Mapping</a>
					</div>
			</div>
		</div>
	</div>
