...
@Entity
@Table(name = "SUPPLIER_SALES_OFFICER")
@AttributeOverrides({
...
public class SuppSalesOfficer extends BusinessEntity{
	...
	public String toString() {
		return "SuppSalesOfficer [ID=" + ID + ", name=" + name + ", effectiveFrom=" + effectiveFromStr + ", contactNo="
